package edu.upenn.cis573.datastructure;
...
/**
 * This class simply stores the id, name and available times 
 * for an individual room. This class also uses the JSONArray 
 * class to get available times of a room.
 */
